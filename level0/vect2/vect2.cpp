...
vect2& vect2::operator=(const vect2& src) { x = src.x; y = src.y; return *this; }

int vect2::operator[](int i) const { return i ? y : x; }
int& vect2::operator[](int i) { return i ? y : x; }
...
vect2& vect2::operator-=(const vect2& o) { x -= o.x; y -= o.y; return *this; }
vect2 vect2::operator+(const vect2& o) const { vect2 t = *this; return t += o; }
vect2 vect2::operator-(const vect2& o) const { vect2 t = *this; return t -= o; }
