...
bigint::bigint(unsigned int num)
{
	...
	std::string tmp;
	while (num) { tmp.push_back((num % 10) + '0'); num /= 10; }
...
bigint bigint::operator+(const bigint& o) const
{
	...
	if (b.size() < a.size()) b.append(a.size() - b.size(), '0');
...
bigint bigint::operator<<(const bigint& o) const { return *this << (unsigned)atoi(o.str.c_str()); }
bigint bigint::operator>>(const bigint& o) const { return *this >> (unsigned)atoi(o.str.c_str()); }
bigint& bigint::operator<<=(const bigint& o) { return *this = *this << o; }
bigint& bigint::operator>>=(const bigint& o) { return *this = *this >> o; }
...
std::ostream& operator<<(std::ostream& os, const bigint& b) { return os << b.str; }
